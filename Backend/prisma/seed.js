...
const prisma = new client_1.PrismaClient({
    adapter: new adapter_pg_1.PrismaPg({ connectionString: requireEnv('DATABASE_URL') }),
});
async function main() {
    ...
    const events = [
        {
            ...
            description: 'Một đêm nhạc live tại trung tâm thành phố với dàn nghệ sĩ khách mời.\n\n- Check-in sớm nhận quà\n- Khu vực F&B\n- Vé điện tử (QR)\n\nLưu ý: Không mang đồ ăn, nước uống từ bên ngoài.',
            ...
            imageUrl: 'https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?auto=format&fit=crop&w=2000&q=80',
            category: 'Âm nhạc',
            isPublished: true,
        ...
        },
        {
            ...
            description: 'Lễ hội ẩm thực với hơn 60 gian hàng.\n\n- Workshop nấu ăn\n- Khu vực trẻ em\n- Vé vào cổng theo khung giờ',
            location: 'Công viên 23/9, TP.HCM',
            startDate: new Date('2026-05-24T09:00:00+07:00'),
            endDate: new Date('2026-05-24T21:00:00+07:00'),
            imageUrl: 'https://images.unsplash.com/photo-1529692236671-f1f6cf9683ba?auto=format&fit=crop&w=2000&q=80',
            category: 'Lễ hội',
            isPublished: true,
            creatorId: organizerId,
            tickets: [
        ...
        },
        {
            ...
            description: 'Sự kiện dành cho designer và PM.\n\n- 8 talks\n- Networking lounge\n- Goodie bag',
            location: 'Rex Hotel, Quận 1, TP.HCM',
            startDate: new Date('2026-06-06T08:30:00+07:00'),
            endDate: new Date('2026-06-06T17:30:00+07:00'),
            imageUrl: 'https://images.unsplash.com/photo-1551836022-d5d88e9218df?auto=format&fit=crop&w=2000&q=80',
            category: 'Hội thảo',
            isPublished: true,
            creatorId: organizerId,
            tickets: [
        ...
        },
        {
            ...
            description: 'Đêm diễn standup với line-up khách mời.\n\n- Doors open 19:00\n- Show starts 20:00',
            location: 'Nhà hát Bến Thành, TP.HCM',
            startDate: new Date('2026-06-14T20:00:00+07:00'),
            endDate: new Date('2026-06-14T22:00:00+07:00'),
            imageUrl: 'https://images.unsplash.com/photo-1517457373958-b7bdd4587205?auto=format&fit=crop&w=2000&q=80',
            category: 'Giải trí',
            isPublished: true,
            creatorId: organizerId,
            tickets: [
        ...
        },
        {
            ...
            description: 'Camp tập luyện 1 ngày cùng HLV.\n\n- Chạy kỹ thuật\n- Dinh dưỡng\n- Phục hồi',
            location: 'Sala City Park, TP.Thủ Đức',
            startDate: new Date('2026-06-21T06:00:00+07:00'),
            endDate: new Date('2026-06-21T12:00:00+07:00'),
            imageUrl: 'https://images.unsplash.com/photo-1521412644187-c49fa049e84d?auto=format&fit=crop&w=2000&q=80',
            category: 'Thể thao',
            isPublished: true,
            creatorId: organizerId,
            tickets: [
        ...
        },
        {
            ...
            imageUrl: 'https://images.unsplash.com/photo-1545239351-1141bd82e8a6?auto=format&fit=crop&w=2000&q=80',
            category: 'Triển lãm',
            isPublished: true,
            creatorId: organizerId,
            tickets: [
